...
{
    [ModSettingsIntSlider("baseNpPerCost", "general", 0, 10, LabelLocKey = "FGO_SETTINGS_UI_BASE_NP_PER_COST.title",
    ...
    [ModSettingsToggle("enableColorlessCards", "general", LabelLocKey = "FGO_SETTINGS_UI_ENABLE_COLORLESS_CARDS.title",
        DescriptionLocKey = "FGO_SETTINGS_UI_ENABLE_COLORLESS_CARDS.hover.desc")]
    [ModSettingsBinding(Source = ModSettingsReflectionBindingSource.Global)]
    public static bool EnableColorlessCards { get; set; } = true;

    [ModSettingsToggle("enablePadoru", "general", LabelLocKey = "FGO_SETTINGS_UI_ENABLE_PADORU.title",
    ...
    [ModSettingsToggle("enableNoCostNoblePhantasm", "general",
