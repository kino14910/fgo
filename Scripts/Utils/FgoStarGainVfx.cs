...
/// <summary>
///     在角色头顶显示 "+xxStar" 浮动文本的 VFX 节点。
///     仿照原版 <c>NDamageNumVfx</c> 的动画行为，但使用自定义文本和金色 (D4AF37)。
///     纯代码创建，不依赖 .tscn 场景文件。
/// </summary>
public partial class FgoStarGainVfx : Label
{
    private static readonly Color StarColor = new("D4AF37");
    ...
    public override void _Ready()
    {
        ...
        AddThemeColorOverride("font_color", StarColor);
        ...
        _tween.TweenProperty(this, "modulate", StarColor, 0.5)
    ...
    /// <summary>
    ///     在指定玩家的角色头顶生成 "+xx✨" 浮动文本。
    ///     amount 为实际增加的 Star 值（正数）。
    /// </summary>
