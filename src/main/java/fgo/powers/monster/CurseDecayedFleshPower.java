...
public class CurseDecayedFleshPower extends BasePower {
    ...
    public int onAttacked(DamageInfo info, int damageAmount) {
        if (info.type != DamageInfo.DamageType.THORNS 
            ...
            addToBot(new ApplyPowerAction(info.owner, owner, new CursePower(info.owner, owner, 1)));
            addToBot(new ApplyPowerAction(info.owner, owner, new VulnerablePower(info.owner, 1, false)));
        }
        return damageAmount;
    }
}
